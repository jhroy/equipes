...
edm5242 = [
	["Denis Desbiens Julien", "Bargain Clément", "Martinet Charlotte"],
	["Ritchot Raphaëlle", "Laurendeau Noémie", "Bergeron Cloé"],
	["Joo Raphaëlle", "Tancrède Pénéloppe", "Soucy Mélina"],
	["Laventure Camille", "LeBlanc Justine", "Roy-Brunet Béatrice"],
	["Blanchet Emond Geneviève", "Daoust-Braun Sarah", "De Simone Frédérique"],
	["Dumoulin Charlotte", "Duchaine Alexandra", "Warnock-Marceau Nina"],
	["Bernier Maxime", "Degré Dominique", "Scott Christophe"],
	["St-André Andy", "Proteau Alex", "Vaillancourt Carl"],
	["Desaulniers Gabryel", "Jolin-Dahel Leïla", "Laverdière Charles"],
	["Ouimet-Juteau Daphné", "Mercure-Langlois Lili", "Laferrière Mathieu"],
	["St-Amour Béland Magalie", "Daraiche Valérie", "Dupuis Léa"],
	["Dufort Cathyane", "Proulx-Chevarie Rose", "Landreville Nancy"],
	["Drapeau Catherine", "Drasse Amélie", "Neveu Isabelle"],
